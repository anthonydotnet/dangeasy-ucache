...
//    var assembly = grunt.file.readJSON(projectDir + 'Properties/AssemblyInfo.json');
    ...
    var version =  pkg.version; //assembly.informationalVersion ? assembly.informationalVersion : assembly.version;
    ...
    grunt.initConfig({
        ...
        nugetpack: {
            dist: {
				...
				options: {
					properties: 'Platform=AnyCPU;Configuration=Release;IconUrl=' + pkg.iconUrl 
				}
            }
        }
    });
